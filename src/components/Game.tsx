...
export default function Game() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-black text-white p-4">
      <h1 className="font-['Space_Grotesk'] text-4xl mb-4 bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 text-transparent bg-clip-text">
        SYNERGY
      </h1>
      ...
      <div className="mt-4 text-gray-400 text-sm text-center bg-gradient-to-b from-gray-800/50 to-gray-900/30 backdrop-blur-sm rounded-lg p-4 border border-gray-700/30">
        ...
        <p>Use the inverse Arrow keys to turn.</p>
